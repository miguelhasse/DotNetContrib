...
{
    internal class ILGeneratorAdapter : ILGeneratorAdapterBase
    {
        private readonly IMappingConfiguration mapCfg;

        public ILGeneratorAdapter(IMappingConfiguration configuration)
        {
