...
namespace System.Linq
{
    ...
    public static class TaskLinqExtensions
    {
        ...
        public static Task<TResult> GroupJoin<TOuter, TInner, TKey, TResult>(this Task<TOuter> outer, Task<TInner> inner, 
            Func<TOuter, TKey> outerKeySelector, Func<TInner, TKey> innerKeySelector, Func<TOuter, Task<TInner>, TResult> resultSelector)
        {
            // Argument validation handled by delegated method call
